"""This logic uploaded from AWS Lambda (create new -> use blueprint -> Authorizer)"""
import os
import re
import jwt
...
def lambda_handler(event, context):
    ...
    if event['authorizationToken']:
        #  if correct token, allow all http method for this endpoint, otherwise - deny all methods
